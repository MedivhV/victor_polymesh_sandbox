...
import type { ApplyExtrinsicResult, ChainProperties, ChainType, DispatchError, DispatchResult, Health, NetworkState, NodeRole, PeerInfo, SyncState } from '@polkadot/types/interfaces/system';
import type { IExtrinsic, Observable } from '@polkadot/types/types';
import type { AffirmationCount, AssetDidResult, AuthorizationType, CanTransferGranularReturn, CappedFee, CddStatus, DidStatus, ExecuteInstructionInfo, IdentityClaim, IdentityId, InstructionId, KeyIdentityData, Leg, Member, NFTs, PipId, PortfolioId, ProtocolOp, RpcDidRecords, Signatory, Ticker, VoteCount } from "./polymesh";
