...
import { Asset, AssetHolder, AssetHoldersOrderBy, AssetTransaction, Authorization, ClaimsGroupBy, ClaimsOrderBy, ClaimTypeEnum, Distribution, DistributionPayment, Event, Extrinsic, ExtrinsicsOrderBy, Instruction, Investment, Leg, MultiSigProposal, MultiSigProposalVote, NftHolder, NftHoldersOrderBy, Portfolio, PortfolioMovement, TickerExternalAgent, TickerExternalAgentAction, TickerExternalAgentHistory, TrustedClaimIssuer } from "./types";
 ...
 */
export declare function distributionQuery(variables: QueryArgs<Distribution, 'assetId' | 'localId'>): QueryOptions<QueryArgs<Distribution, 'assetId' | 'localId'>>;
/**
 * @hidden
 *
 ...
 */
export declare function nftHoldersQuery(filters: QueryArgs<NftHolder, 'identityId'>, size?: BigNumber, start?: BigNumber, orderBy?: NftHoldersOrderBy): QueryOptions<PaginatedQueryArgs<QueryArgs<NftHolder, 'identityId'>>>;
 ...
 */
export declare function settlementsForAllPortfoliosQuery(filters: Omit<QuerySettlementFilters, 'portfolioId'>): QueryOptions<QueryArgs<Leg, 'fromId' | 'toId' | 'assetId' | 'addresses'>>;
/**
 * @hidden
 *
 * Get Settlements where a Portfolio is involved
 ...
 * Get Settlements for all portfolios
 */
export declare function portfoliosMovementsQuery(filters: Omit<QuerySettlementFilters, 'portfolioId'>): QueryOptions<QueryArgs<PortfolioMovement, 'fromId' | 'toId' | 'assetId' | 'address'>>;
 ...
 */
export declare function nftTransactionQuery(filters: QueryArgs<AssetTransaction, 'assetId'>, size?: BigNumber, start?: BigNumber): QueryOptions<PaginatedQueryArgs<QueryArgs<AssetTransaction, 'assetId'>>>;
/**
 * @hidden
 *
 ...
 */
export declare function multiSigProposalQuery(variables: QueryArgs<MultiSigProposal, 'multisigId' | 'proposalId'>): QueryOptions<QueryArgs<MultiSigProposal, 'multisigId' | 'proposalId'>>;
/**
 * @hidden
 *
 * Get MultiSig proposal votes for a given proposalId ({multiSigAddress}/{proposalId})
 */
export declare function multiSigProposalVotesQuery(variables: QueryArgs<MultiSigProposalVote, 'proposalId'>): QueryOptions<QueryArgs<MultiSigProposalVote, 'proposalId'>>;
/**
 *  @hidden
 */
export declare function createCustomClaimTypeQueryFilters(variables: CustomClaimTypesQuery): {
    args: string;
    filter: string;
};
 ...
 */
export declare function customClaimTypeQuery(size?: BigNumber, start?: BigNumber, dids?: string[]): QueryOptions<PaginatedQueryArgs<CustomClaimTypesQuery>>;
/**
 * @hidden
 *
 * Get holders on an NFT Collection
 */
export declare function nftCollectionHolders(assetId: string, size?: BigNumber, start?: BigNumber): QueryOptions<PaginatedQueryArgs<QueryArgs<NftHolder, 'assetId'>>>;
declare type MultiSigProposalQueryParameters = {
    multisigId: string;
};
/**
 * @hidden
 ...
 */
export declare function multiSigProposalsQuery(multisigId: string, size?: BigNumber, start?: BigNumber): QueryOptions<PaginatedQueryArgs<MultiSigProposalQueryParameters>>;
export {};
