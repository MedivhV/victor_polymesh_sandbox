 ...
 * @hidden
 */
export declare function nftToMeshNft(ticker: string, nfts: (Nft | BigNumber)[], context: Context): PolymeshPrimitivesNftNfTs;
/**
 * @hidden
 */
 ...
 * @hidden
 */
export declare function identitiesSetToIdentities(identitySet: BTreeSet<PolymeshPrimitivesIdentityId>, context: Context): Identity[];
/**
 * @hidden
 */
 ...
 * @hidden
 */
export declare function nftDispatchErrorToTransferError(error: DispatchError, context: Context): TransferError;
/**
 * @hidden
 */
export declare function granularCanTransferResultToTransferBreakdown(result: GranularCanTransferResult, validateNftResult: DispatchResult | undefined, context: Context): TransferBreakdown;
/**
 * @hidden
 */
/**
 ...
 * @hidden
 */
export declare function legToFungibleLeg(leg: {
 ...
 * @hidden
 */
export declare function legToNonFungibleLeg(leg: {
    sender: PolymeshPrimitivesIdentityIdPortfolioId;
    receiver: PolymeshPrimitivesIdentityIdPortfolioId;
 ...
 * @hidden
 */
export declare function toCustomClaimTypeWithIdentity(data: MiddlewareCustomClaimType[]): CustomClaimTypeWithDid[];
/**
 * @hidden
 */
export declare function toHistoricalSettlements(settlementsResult: ApolloQueryResult<Ensured<Query, 'legs'>>, portfolioMovementsResult: ApolloQueryResult<Ensured<Query, 'portfolioMovements'>>, filter: string, context: Context): HistoricSettlement[];
/**
 * @hidden
 */
export declare function mediatorAffirmationStatusToStatus(rawStatus: PolymeshPrimitivesSettlementMediatorAffirmationStatus): Omit<MediatorAffirmation, 'identity'>;
/**
 * @hidden
 */
export declare function assetCountToRaw(counts: {
    fungible: u32;
    nonFungible: u32;
    offChain: u32;
}, context: Context): PolymeshPrimitivesSettlementAssetCount;
/**
 * @hidden
 */
export declare function createRawExtrinsicStatus(status: ExtrinsicStatus['type'], value: Hash, context: Context): ExtrinsicStatus;
