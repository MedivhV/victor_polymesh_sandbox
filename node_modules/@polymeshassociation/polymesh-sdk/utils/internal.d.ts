...
import { Account, BaseAsset, Checkpoint, CheckpointSchedule, ChildIdentity, Context, FungibleAsset, Identity, MultiSig, Nft } from "../internal";
import { Claim as MiddlewareClaim } from "../middleware/types";
import { MiddlewareScope } from "../middleware/typesV1";
import { Asset, Authorization, AuthorizationRequest, Claim, Condition, InputCaCheckpoint, InputCondition, ModuleName, NextKey, NoArgsProcedureMethod, OptionalArgsProcedureMethod, PaginationOptions, PermissionedAccount, ProcedureMethod, RemoveAssetStatParams, StatType, SubCallback, TransferRestriction, TransferRestrictionType, TxTag, UnsubCallback } from "../types";
 ...
 * @hidden
 */
export declare function createClaim(claimType: string, jurisdiction: Falsyable<string>, middlewareScope: Falsyable<MiddlewareScope>, cddId: Falsyable<string>, customClaimTypeId: Falsyable<BigNumber>): Claim;
/**
 * @hidden
 */
 ...
 */
export declare function isAllowedCharacters(value: string): boolean;
/**
 * @hidden
 *
 ...
 */
export declare function asBaseAsset(asset: string | BaseAsset, context: Context): BaseAsset;
/**
 * @hidden
 *
 * @note alternatively {@link asBaseAsset} returns a generic `BaseAsset`, but is synchronous
 */
export declare function asAsset(asset: string | Asset, context: Context): Promise<Asset>;
/**
 * @hidden
 ...
 */
export declare function extractProtocol(url: string): string | undefined;
/**
 * @hidden
 *
 ...
 */
export declare function assembleAssetQuery(assetDetails: Option<PalletAssetSecurityToken>[], tickers: string[], context: Context): Asset[];
/**
 * @hidden
 */
 ...
 * @hidden
 */
export declare function areSameClaims(claim: Claim, { scope, type, customClaimTypeId }: MiddlewareClaim): boolean;
/**
 * @hidden
 */
export declare function assertNoPendingAuthorizationExists(params: {
 ...
 * @hidden
 */
export declare function assertIdentityExists(identity: Identity): Promise<void>;
/**
 * @hidden
 */
export declare function getAccount(args: {
    address: string;
}, context: Context): Promise<Account | MultiSig>;
