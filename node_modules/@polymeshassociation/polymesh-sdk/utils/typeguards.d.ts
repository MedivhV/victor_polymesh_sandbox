 ...
 * @hidden
 */
declare type IsFungibleLegGuard = (leg: InstructionLeg) => leg is FungibleLeg;
/**
 ...
 * ```
 */
export declare const isFungibleLegBuilder: (leg: InstructionLeg, context: Context) => Promise<IsFungibleLegGuard>;
/**
 * @hidden
 */
declare type IsNftLegGuard = (leg: InstructionLeg) => leg is NftLeg;
/**
 ...
 */
export declare const isNftLegBuilder: (leg: InstructionLeg, context: Context) => Promise<IsNftLegGuard>;
export {};
