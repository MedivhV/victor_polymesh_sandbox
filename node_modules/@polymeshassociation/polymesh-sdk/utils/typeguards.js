 ...
 * ```
 */
const isFungibleLegBuilder = (leg, context) => __awaiter(void 0, void 0, void 0, function* () {
    const asset = yield (0, internal_2.asAsset)(leg.asset, context);
    return (iLeg) => {
        return asset instanceof internal_1.FungibleAsset;
    };
});
exports.isFungibleLegBuilder = isFungibleLegBuilder;
/**
 ...
 */
const isNftLegBuilder = (leg, context) => __awaiter(void 0, void 0, void 0, function* () {
    const asset = yield (0, internal_2.asAsset)(leg.asset, context);
    return (iLeg) => {
        return asset instanceof internal_1.NftCollection;
    };
});
exports.isNftLegBuilder = isNftLegBuilder;
