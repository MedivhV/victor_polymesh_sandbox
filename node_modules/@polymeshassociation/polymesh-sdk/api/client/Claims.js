...
class Claims {
    ...
    getIdentitiesWithClaims(opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filters = {
                ...
                claimTypes: Array.isArray(claimTypes) ? claimTypes.map(ct => types_1.ClaimTypeEnum[ct]) : undefined,
                includeExpired,
            };
            if (!targets) {
    ...
    getCddClaims(opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { context, context: { polymeshApi: { call }, }, } = this;
            ...
            const result = yield identity.validCddClaims(rawDid, null);
            const data = [];
    ...
    getCustomClaimTypeByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const { context: { polymeshApi: { query: { identity }, }, }, } = this;
            const customClaimTypeIdOpt = yield identity.customClaimsInverse(name);
            if (customClaimTypeIdOpt.isEmpty) {
                return null;
            }
            return { id: (0, conversion_1.u32ToBigNumber)(customClaimTypeIdOpt.value), name };
        });
    }
    /**
    ...
    getCustomClaimTypeById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customClaimTypeIdOpt = yield identity.customClaims((0, conversion_1.bigNumberToU32)(id, context));
            if (customClaimTypeIdOpt.isEmpty) {
                return null;
            }
            return { id, name: (0, conversion_1.bytesToString)(customClaimTypeIdOpt.value) };
        });
    }
    /**
    ...
    getAllCustomClaimTypes(opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { size = new bignumber_js_1.default(constants_1.DEFAULT_GQL_PAGE_SIZE), start = new bignumber_js_1.default(0), dids } = opts;
            const { data: { customClaimTypes: { nodes, totalCount }, }, } = yield context.queryMiddleware((0, queries_1.customClaimTypeQuery)(size, start, dids));
            ...
            return {
                data: (0, conversion_1.toCustomClaimTypeWithIdentity)(nodes),
                next,
                count,
            };
        });
