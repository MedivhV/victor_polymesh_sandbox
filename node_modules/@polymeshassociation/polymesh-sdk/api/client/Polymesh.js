...
class Polymesh {
    ...
    static connect(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { types, rpc, signedExtensions, runtime } = schema_1.default;
                const connectionProtocol = (0, internal_2.extractProtocol)(nodeUrl);
                const provider = connectionProtocol.startsWith('http')
                    ? new api_1.HttpProvider(nodeUrl)
                    : new api_1.WsProvider(nodeUrl);
                ...
                throw new internal_1.PolymeshError({
                    code,
                    message: `Error while connecting to "${nodeUrl}": "${message || 'The node couldn’t be reached'}"`,
                });
            }
            if (middlewareV2) {
