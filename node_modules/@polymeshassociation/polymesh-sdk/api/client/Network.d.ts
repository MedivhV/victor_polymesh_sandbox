...
import { EventIdentifier, ExtrinsicDataWithFees, MiddlewareMetadata, NetworkProperties, ProcedureMethod, ProtocolFees, SubCallback, SubmissionDetails, TransactionPayload, TransferPolyxParams, TxTag, UnsubCallback } from "../../types";
/**
...
export declare class Network {
     ...
     */
    submitTransaction(txPayload: TransactionPayload, signature: string): Promise<SubmissionDetails>;
    /**
