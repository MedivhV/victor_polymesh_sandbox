...
import { CddClaim, ClaimData, ClaimScope, ClaimType, CustomClaimType, CustomClaimTypeWithDid, IdentityWithClaims, ModifyClaimsParams, ProcedureMethod, RegisterCustomClaimTypeParams, ResultSet, Scope } from "../../types";
/**
...
export declare class Claims {
     ...
     */
    getCustomClaimTypeByName(name: string): Promise<CustomClaimType | null>;
    /**
     * Retrieves a custom claim type based on its ID
     *
     * @param id - The ID of the custom claim type to retrieve
     */
    getCustomClaimTypeById(id: BigNumber): Promise<CustomClaimType | null>;
    /**
