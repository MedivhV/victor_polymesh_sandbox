...
exports.addManualFees = exports.createCreateGroupResolver = exports.createAuthorizationResolver = exports.assertGroupDoesNotExist = exports.getGroupFromPermissions = exports.assertValidCdd = exports.assertAuthorizationRequestValid = exports.UnreachableCaseError = exports.assertAddRelayerPayingKeyAuthorizationValid = exports.assertMultiSigSignerAuthorizationValid = exports.assertTransferAssetOwnershipAuthorizationValid = exports.assertTransferTickerAuthorizationValid = exports.assertAttestPrimaryKeyAuthorizationValid = exports.assertPrimaryKeyRotationAuthorizationValid = exports.assertRequirementsNotTooComplex = exports.isFullGroupType = exports.assertDistributionDatesValid = exports.assertCaCheckpointValid = exports.assertCaTaxWithholdingsValid = exports.assertDistributionOpen = exports.assertSecondaryAccounts = exports.assertVenueExists = exports.assertPortfolioExists = exports.assertInstructionValidForManualExecution = exports.assertInstructionValid = void 0;
 ...
 * @hidden
 */
function assertValidCdd(identity, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const id = (0, internal_2.asIdentity)(identity, context);
        const validCdd = yield id.hasValidCdd();
        if (!validCdd) {
            throw new internal_1.PolymeshError({
                code: types_1.ErrorCode.UnmetPrerequisite,
...
exports.assertValidCdd = assertValidCdd;
/**
 * @hidden
 *
