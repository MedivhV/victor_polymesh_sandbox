...
function assertTickerOk(ticker) {
    if (!(0, internal_2.isAllowedCharacters)(ticker)) {
...
function prepareCreateNftCollection(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { ticker, nftType, name, securityIdentifiers = [], collectionKeys, documents, fundingRound, } = args;
        ...
        const rawFundingRound = (0, internal_2.optionize)(conversion_1.stringToBytes)(fundingRound, context);
...
function getAuthorization({ ticker, documents }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (status === types_1.TickerReservationStatus.Reserved) {
            ...
            return {
                permissions: Object.assign(Object.assign({}, permissions), { assets: [new internal_1.BaseAsset({ ticker }, context)] }),
            };
        }
        return { permissions };
    });
