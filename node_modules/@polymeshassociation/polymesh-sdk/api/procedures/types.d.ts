...
export declare type RotatePrimaryKeyToSecondaryParams = {
    permissions: PermissionsLike;
    /**
     * The Account that should function as the primary key of the newly created Identity. Can be ss58 encoded address or an instance of Account
     */
...
export declare type InstructionLeg = InstructionFungibleLeg | InstructionNftLeg;
...
export declare type AffirmAsMediatorParams = {
    expiry?: Date;
};
export declare type ModifyInstructionAffirmationParams = InstructionIdParams & (({
    ...
    operation: InstructionAffirmationOperation.Reject | InstructionAffirmationOperation.RejectAsMediator;
} & RejectInstructionParams) | ({
    operation: InstructionAffirmationOperation.AffirmAsMediator;
} & AffirmAsMediatorParams) | {
    operation: InstructionAffirmationOperation.WithdrawAsMediator | InstructionAffirmationOperation.RejectAsMediator;
});
...
export declare type AllowIdentityToCreatePortfoliosParams = {
    did: Identity | string;
};
