...
function prepareExecuteManualInstruction(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { context: { polymeshApi: { tx: { settlement: settlementTx }, query: { settlement }, call, }, }, context, storage: { portfolios, instructionDetails, signerDid }, } = this;
        ...
        const { fungibleTokens, nonFungibleTokens, offChainAssets, consumedWeight } = yield call.settlementApi.getExecuteInstructionInfo(rawInstructionId);
        return {
