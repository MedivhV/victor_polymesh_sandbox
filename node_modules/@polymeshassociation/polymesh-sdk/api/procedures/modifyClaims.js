...
const findClaimsByOtherIssuers = (claims, claimsByDid, signerDid) => claims.reduce((prev, { target, claim }) => {
    var _a;
    const targetClaims = (_a = claimsByDid[(0, conversion_1.signerToString)(target)]) !== null && _a !== void 0 ? _a : [];
    const claimIssuedByOtherDids = targetClaims.some(targetClaim => (0, internal_2.areSameClaims)(claim, targetClaim) && targetClaim.issuerId !== signerDid);
...
function prepareModifyClaims(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (shouldValidateWithMiddleware) {
            ...
            const result = yield context.queryMiddleware((0, queries_1.claimsQuery)({
                dids: allTargets,
                trustedClaimIssuers: [currentDid],
                includeExpired: true,
            }));
            const { data: { claims: { nodes: claimsData }, }, } = result;
            const claimsByDid = (0, lodash_1.groupBy)(claimsData, 'targetId');
            const claimsByOtherIssuers = findClaimsByOtherIssuers(claims, claimsByDid, currentDid);
