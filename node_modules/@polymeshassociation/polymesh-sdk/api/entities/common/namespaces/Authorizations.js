...
class Authorizations extends internal_1.Namespace {
    ...
    getReceived(opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { context, parent, context: { polymeshApi: { call }, }, } = this;
            ...
            if (opts === null || opts === void 0 ? void 0 : opts.type) {
                result = yield identityApi.getFilteredAuthorizations(signatory, rawBoolean, (0, conversion_1.authorizationTypeToMeshAuthorizationType)(opts.type, context));
            }
            else {
                result = yield identityApi.getFilteredAuthorizations(signatory, rawBoolean, null);
            }
