...
import { BaseAsset, ChildIdentity, Context, Entity, FungibleAsset, Venue } from "../../../internal";
import { AssetHoldersOrderBy, NftHoldersOrderBy } from "../../../middleware/types";
import { Asset, CheckRolesResult, DistributionWithDetails, GroupedInstructions, GroupedInvolvedInstructions, HeldNfts, HistoricInstruction, MultiSigSigners, PaginationOptions, PermissionedAccount, ProcedureMethod, ResultSet, Role, SubCallback, UnlinkChildParams, UnsubCallback } from "../../../types";
...
export declare class Identity extends Entity<UniqueIdentifiers, string> {
     ...
     */
    isAssetPreApproved(asset: BaseAsset | string): Promise<boolean>;
    /**
