...
class Instruction extends internal_1.Entity {
    ...
    constructor(identifiers, context) {
        ...
        this.reject = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: args => [
                ...
                Object.assign({ id, operation: types_2.InstructionAffirmationOperation.Reject }, args),
            ],
            optionalArgs: true,
        }, context);
        this.affirm = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: args => [
                internal_1.modifyInstructionAffirmation,
                Object.assign({ id, operation: types_2.InstructionAffirmationOperation.Affirm }, args),
            ],
            optionalArgs: true,
        }, context);
        this.withdraw = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: args => [
                internal_1.modifyInstructionAffirmation,
                Object.assign({ id, operation: types_2.InstructionAffirmationOperation.Withdraw }, args),
            ],
            optionalArgs: true,
        }, context);
        this.rejectAsMediator = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: () => [
                internal_1.modifyInstructionAffirmation,
                { id, operation: types_2.InstructionAffirmationOperation.RejectAsMediator },
            ],
            voidArgs: true,
        }, context);
        this.affirmAsMediator = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: args => [
                internal_1.modifyInstructionAffirmation,
                Object.assign({ id, operation: types_2.InstructionAffirmationOperation.AffirmAsMediator }, args),
            ],
            optionalArgs: true,
        }, context);
        this.withdrawAsMediator = (0, internal_3.createProcedureMethod)({
            getProcedureAndArgs: () => [
                internal_1.modifyInstructionAffirmation,
                { id, operation: types_2.InstructionAffirmationOperation.WithdrawAsMediator },
            ],
            voidArgs: true,
        }, context);
            ...
            const data = legs.map(([, leg]) => {
                if (leg.isSome) {
                    ...
                    if (legValue.isFungible) {
                        ...
                        const from = (0, conversion_1.meshPortfolioIdToPortfolio)(sender, context);
                        const to = (0, conversion_1.meshPortfolioIdToPortfolio)(receiver, context);
                        const { ticker, ids } = (0, conversion_1.meshNftToNftId)(nfts);
                        return {
                            from,
                            to,
                            nfts: ids.map(nftId => new internal_1.Nft({ ticker, id: nftId }, context)),
                            asset: new internal_1.NftCollection({ ticker }, context),
                        };
                    }
                    else {
    ...
    getStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [executedEventIdentifier, failedEventIdentifier] = yield Promise.all([
                this.getInstructionEventFromMiddleware(types_1.InstructionStatusEnum.Executed),
                this.getInstructionEventFromMiddleware(types_1.InstructionStatusEnum.Failed),
            ]);
            if (executedEventIdentifier) {
                return {
                    status: types_3.InstructionStatus.Success,
    ...
    getMediators() {
        return __awaiter(this, void 0, void 0, function* () {
            const { id, context, context: { polymeshApi: { query: { settlement }, }, }, } = this;
            const rawId = (0, conversion_1.bigNumberToU64)(id, context);
            const rawAffirms = yield settlement.instructionMediatorsAffirmations.entries(rawId);
            return rawAffirms.map(([key, affirmStatus]) => {
                ...
                const { status, expiry } = (0, conversion_1.mediatorAffirmationStatusToStatus)(affirmStatus);
    ...
    internalToExternalStatus(status) {
        switch (status) {
            case internal_2.InstructionStatus.Pending:
                return types_3.InstructionStatus.Pending;
            case internal_2.InstructionStatus.Failed:
                return types_3.InstructionStatus.Failed;
            case internal_2.InstructionStatus.Success:
                return types_3.InstructionStatus.Success;
            case internal_2.InstructionStatus.Rejected:
                return types_3.InstructionStatus.Rejected;
        }
        return null;
    }
}
