...
import { DefaultPortfolio, FungibleAsset, Identity, Instruction, Nft, NumberedPortfolio, Venue } from "../../../internal";
...
export declare type Leg = FungibleLeg | NftLeg;
...
export declare type MediatorAffirmation = {
    identity: Identity;
    status: AffirmationStatus;
    /**
