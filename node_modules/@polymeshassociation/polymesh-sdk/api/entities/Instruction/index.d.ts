...
import { AffirmAsMediatorParams, AffirmOrWithdrawInstructionParams, DefaultPortfolio, ExecuteManualInstructionParams, NoArgsProcedureMethod, NumberedPortfolio, OptionalArgsProcedureMethod, PaginationOptions, RejectInstructionParams, ResultSet, SubCallback, UnsubCallback } from "../../../types";
import { InstructionAffirmation, InstructionDetails, InstructionStatus, InstructionStatusResult, Leg, MediatorAffirmation } from './types';
...
export declare class Instruction extends Entity<UniqueIdentifiers, string> {
     ...
     * @note reject on `SettleManual` behaves just like unauthorize
     */
    rejectAsMediator: NoArgsProcedureMethod<Instruction>;
    /**
     * Affirm this instruction as a mediator (authorize)
     */
    affirmAsMediator: OptionalArgsProcedureMethod<AffirmAsMediatorParams, Instruction>;
    /**
     * Withdraw affirmation from this instruction as a mediator (unauthorize)
     */
    withdrawAsMediator: NoArgsProcedureMethod<Instruction>;
    /**
