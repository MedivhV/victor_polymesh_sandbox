...
class Account extends internal_1.Entity {
    ...
    getTransactionHistory(filters = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = transactionList.map(({ blockId, extrinsicIdx, address: signerAddress, nonce, moduleId: extrinsicModuleId, callId: extrinsicCallId, paramsTxt, success: txSuccess, specVersionId, extrinsicHash, block, }) => {
    ...
    getMultiSig() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new internal_1.MultiSig({ address: (0, conversion_1.accountIdToString)(rawKeyRecord.asMultiSigSignerKey) }, context);
        });
    }
    /**
    ...
    getCurrentNonce() {
        return __awaiter(this, void 0, void 0, function* () {
            const { context: { polymeshApi: { call: { accountNonceApi: { accountNonce }, }, }, }, address, context, } = this;
            const index = yield accountNonce((0, conversion_1.stringToAccountId)(address, context));
    ...
    getPendingProposals() {
        return __awaiter(this, void 0, void 0, function* () {
            const multiSig = yield this.getMultiSig();
            if (!multiSig) {
                throw new internal_1.PolymeshError({
