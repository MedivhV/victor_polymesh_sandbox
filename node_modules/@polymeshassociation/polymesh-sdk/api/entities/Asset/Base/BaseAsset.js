...
class BaseAsset extends internal_1.Entity {
    ...
    constructor(identifiers, context) {
        ...
        this.addRequiredMediators = (0, internal_2.createProcedureMethod)({
            getProcedureAndArgs: args => [internal_1.addAssetMediators, Object.assign({ asset: this }, args)],
        }, context);
        this.removeRequiredMediators = (0, internal_2.createProcedureMethod)({
            getProcedureAndArgs: args => [internal_1.removeAssetMediators, Object.assign({ asset: this }, args)],
        }, context);
    ...
    getRequiredMediators() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rawTicker = (0, conversion_1.stringToTicker)(ticker, context);
            const rawMediators = yield query.asset.mandatoryMediators(rawTicker);
            return (0, conversion_1.identitiesSetToIdentities)(rawMediators, context);
        });
    }
    /**
    ...
    getVenueFilteringDetails() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rawTicker = (0, conversion_1.stringToTicker)(ticker, context);
            const [rawIsEnabled, venueEntries] = yield Promise.all([
            ...
            const isEnabled = (0, conversion_1.boolToBoolean)(rawIsEnabled);
            return {
                isEnabled,
                allowedVenues,
            };
