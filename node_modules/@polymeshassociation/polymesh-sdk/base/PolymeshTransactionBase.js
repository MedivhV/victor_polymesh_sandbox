...
class PolymeshTransactionBase {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (context.supportsSubscription()) {
                ...
                yield txWithArgs
                    ...
                    .catch((err) => {
                    const error = (0, utils_1.handleTransactionSubmissionError)(err);
                    throw new internal_1.PolymeshError(error);
                });
                const finalizedReceipt = yield (0, utils_1.pollForTransactionFinalization)(txWithArgs.hash, startingBlock, context);
                ...
                // if the extrinsic failed due to an on-chain error, we should handle it in a special way
                const [extrinsicFailedEvent] = (0, internal_3.filterEventRecords)(finalizedReceipt, 'system', 'ExtrinsicFailed', true);
                if (extrinsicFailedEvent) {
                    const { data } = extrinsicFailedEvent;
                    const error = (0, utils_1.handleExtrinsicFailure)(data[0]);
                    throw error;
    ...
    toSignablePayload(metadata = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let nonce = context.getNonce().toNumber();
            if (nonce < 0) {
                const nextIndex = yield polymeshApi.call.accountNonceApi.accountNonce(signingAddress);
            ...
            if (mortality.immortal) {
                ...
                era = context.createType('ExtrinsicEra', {
                    ...
                    period: (_b = (_a = mortality.lifetime) === null || _a === void 0 ? void 0 : _a.toNumber()) !== null && _b !== void 0 ? _b : constants_1.DEFAULT_LIFETIME_PERIOD,
                });
