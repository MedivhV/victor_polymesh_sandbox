...
class Context {
    ...
    setSigningAddress(signingAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, internal_2.assertAddressValid)(signingAddress, this.ss58Format);
     ...
     */
    assertHasSigningAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const { signingManager } = this;
            if (!signingManager) {
                throw new internal_1.PolymeshError({
                    code: types_3.ErrorCode.General,
    ...
    getExternalSigner() {
        const { signingManager } = this;
        return signingManager === null || signingManager === void 0 ? void 0 : signingManager.getExternalSigner();
    }
    /**
     * @hidden
     *
    ...
    getIdentityClaimsFromChain(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const { polymeshApi: { query: { identity }, }, } = this;
            const { targets, claimTypes = Object.values(types_3.ClaimType), trustedClaimIssuers, includeExpired, } = args;
    ...
    getIdentityClaimsFromMiddleware(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data: { claims: { nodes: claimsList, totalCount }, }, } = yield this.queryMiddleware((0, queries_1.claimsQuery)({
                ...
                claimTypes: claimTypes === null || claimTypes === void 0 ? void 0 : claimTypes.map(ct => types_2.ClaimTypeEnum[ct]),
                includeExpired,
            }, size, start));
    ...
    issuedClaims(opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!targets) {
                throw new internal_1.PolymeshError({
                    code: types_3.ErrorCode.MiddlewareError,
    ...
    getLatestBlock() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.supportsSubscription()) {
                 ...
                 */
                const finalizedHead = yield chain.getFinalizedHead();
                const { number } = yield chain.getHeader(finalizedHead);
                return (0, conversion_1.u32ToBigNumber)(number.unwrap());
            }
        });
    }
     ...
     * @hidden
     */
    assertSupportsSubscription() {
        if (!this.supportsSubscription()) {
            throw new internal_1.PolymeshError({
                code: types_3.ErrorCode.General,
                message: 'Subscriptions are not supported over http. SDK must be initialized with a ws connection in order to subscribe',
            });
        }
    }
}
